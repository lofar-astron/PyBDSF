...
C  HESSIAN APPROXIMATION TO _USE_ IN THIS COMPUTING.
C
...
C
 150  IF (IV(MODE) .GT. P) GO TO 240
      ...
      IV(1) = 2
C
C  ***  COMPUTE GRADIENT ONLY (FOR _USE_ IN COVARIANCE COMPUTATION)  ***
C
      GI = G1
      DO 160 L = 1, P
...
C     ***  _USE_ STEP VECTOR (ALLOCATED BY DG7LIT) FOR SCRATCH.
C
      RMAT1 = IV(RMAT)
