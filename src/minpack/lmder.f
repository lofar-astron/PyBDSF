     ...
     *                 ipvt,qtf,wa1,wa2,wa3,wa4,userpar)
      external fcn,userpar
...
c
      iflag = 1
      call fcn(m,n,x,fvec,fjac,ldfjac,iflag,userpar)
      nfev = 1
...
c
            iflag = 1
            call fcn(m,n,wa2,wa4,fjac,ldfjac,iflag,userpar)
            nfev = nfev + 1
            if (iflag .lt. 0) go to 300
            fnorm1 = enorm(m,wa4)
c
...
c
      ...
      iflag = 0
      if (nprint .gt. 0) call fcn(m,n,x,fvec,fjac,ldfjac,iflag,userpar)
      return
c
